const categories = {
  "Zboża": ["pszenica", "jęczmień", "owies", "żyto", "orkisz", "rzepak"],
  "Rośliny": ["kukurydza", "słonecznik", "len", "wysłodki buraczane", "soja", "groch", "lucerna"],
  "Owoce i warzywa": ["jabłko", "marchew"],
  "Suplementy i inne": ["białko w suplementach", "gluten"]
};
